...
#define GAMESERVER_VERSION "[ZoeTeam] %s - Versão: 1.0. (%s)"   
...
// Correção para bibliotecas antigas (como LUA) no VS2015+
#if _MSC_VER >= 1900
#include <stdio.h>

extern "C" {
	FILE * __cdecl __iob_func(void) {
		struct _iobuf_VS2015 { FILE _file; };
		return (FILE*)((_iobuf_VS2015*)stdin);
	}
}
#endif