...
void CBloodCastle::SetState_EMPTY(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	LogAdd(LOG_BLACK,"[Blood Castle] (%d) Definir estado como VAZIO",(lpLevel->Level+1));
}
...
void CBloodCastle::SetState_READY(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	LogAdd(LOG_BLACK,"[Blood Castle] (%d) Estado definido como PRONTO",(lpLevel->Level+1));
}
...
void CBloodCastle::SetState_STAND(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	LogAdd(LOG_BLACK,"[Blood Castle] (%d) Definir estado STAND",(lpLevel->Level+1));
}
...
void CBloodCastle::SetState_START(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	LogAdd(LOG_BLACK,"[Blood Castle] (%d) Definir estado INICIAR",(lpLevel->Level+1));
}
...
void CBloodCastle::SetState_CLEAN(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	LogAdd(LOG_BLACK,"[Blood Castle] (%d) Definir estado como LIMPO",(lpLevel->Level+1));
}
...
void CBloodCastle::CheckSync(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	if(day > 0)
	{
		LogAdd(LOG_BLACK,"[Blood Castle] (%d) Hora de início da sincronização. [%d] dia [%d] hora [%d] min restantes",(lpLevel->Level+1),day,hr,min);
	}
	else if(hr > 0)
	{
		LogAdd(LOG_BLACK,"[Blood Castle] (%d) Hora de início da sincronização. [%d] horas [%d] minutos restantes",(lpLevel->Level+1),hr,min);
	}
	else
	{
		LogAdd(LOG_BLACK,"[Blood Castle] (%d) Hora de início da sincronização. [%d] min restantes",(lpLevel->Level+1),min);
	}
}
